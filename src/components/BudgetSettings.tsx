      ...
      <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative rounded-2xl border border-slate-200 focus-within:border-emerald-500 shadow-sm transition-all focus-within:ring-2 focus-within:ring-emerald-500/15 overflow-hidden">
                ...
                <input
                  ...
                  className="w-full py-3 pl-9 pr-4 text-lg font-bold font-mono text-slate-900 focus:outline-none"
                  required
                />
              </div>
        ...
        <div className="rounded-3xl border border-slate-100 bg-slate-50 p-6 shadow-xs space-y-4.5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="hidden sm:block text-slate-300 self-stretch border-l border-slate-200" />
            ...
            <div>
              ...
              <span className={`text-2xl font-black font-mono ${availableBudget - totalAllocated < 0 ? 'text-rose-500' : 'text-slate-700'}`}>
          ...
          {isOverAllocated && (
            <div className="flex gap-2.5 rounded-2xl bg-amber-50 border border-amber-200/50 p-4 text-xs font-semibold text-amber-900 leading-relaxed">
              <AlertTriangle className="h-5 w-5 text-amber-500 shrink-0" />
              <div>
                <p className="font-bold">Cảnh báo: Lạm chi hạn mức phân chia!</p>
                <p className="font-normal text-[11px] text-slate-600">
          ...
          {!isOverAllocated && totalAllocated > 0 && (
            <div className="flex gap-2.5 rounded-2xl bg-emerald-50 border border-emerald-200/50 p-4 text-xs font-semibold text-emerald-900 leading-relaxed">
              <CheckCircle className="h-5 w-5 text-emerald-500 shrink-0" />
              <div>
                <p className="font-bold">Thiết lập hợp lý!</p>
                <p className="font-normal text-[11px] text-slate-600">
              ...
              >
                ...
                <div className="relative rounded-xl border border-slate-200 shadow-sm focus-within:border-emerald-500 overflow-hidden w-40">
                  ...
                  <input
                    ...
                    className="w-full text-right pr-3.5 py-2 text-sm font-bold font-mono text-slate-800 focus:outline-none"
                    placeholder="0"
                  />
                </div>
              </div>
